...
public class ModTags {
    ...
    public static class Biomes{
        ...
        public static final TagKey<Biome> BLOOD_OCEANS = createTag(VoidlessMod.MODID,"blood_oceans");
        ...
        public static TagKey<Biome> createTag(String namepsace, String path) {
            return BiomeTags.create(ResourceLocation.fromNamespaceAndPath(namepsace, path));
        }
