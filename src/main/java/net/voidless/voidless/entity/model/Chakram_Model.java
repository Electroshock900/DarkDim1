package net.voidless.voidless.entity.model;// Made with Blockbench 4.7.4
...
public class Chakram_Model<T extends ChakramEntity> extends HierarchicalModel<ChakramEntity> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "chakram"), "main");
	private final ModelPart group2;

	public static final ResourceLocation TEXTURE = ResourceLocation.parse("voidless:textures/entity/projectile/chakram.png");
	public Chakram_Model(ModelPart root) {
	...
	/**
	@Override
	public ResourceLocation getModelResource(Cactus_Buddy2 animatable) {
		return new ResourceLocation(DeathMod.MODID,"geo/chakram.geo.json");

	}

	@Override
	public ResourceLocation getTextureResource(Cactus_Buddy2 animatable) {
		return new ResourceLocation(DeathMod.MODID,"textures/entity/chakram.png");
	}
...
**/
	@Override
	public void setupAnim(ChakramEntity p_102618_, float p_102619_, float p_102620_, float p_102621_, float p_102622_, float p_102623_) {
