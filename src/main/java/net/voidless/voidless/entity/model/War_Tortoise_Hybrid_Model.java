...
import net.voidless.voidless.entity.animation.WarTortoiseHybridAnimation;// Made with Blockbench 4.11.2
...
public class War_Tortoise_Hybrid_Model<T extends WarTortoiseHybrid> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "war_tortoise_hybrid"), "main");
	public static final ModelLayerLocation ARMOR_LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "war_tortoise_hybrid_armor"), "main");
