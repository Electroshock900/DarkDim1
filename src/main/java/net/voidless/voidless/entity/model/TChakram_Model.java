...
public class TChakram_Model<T extends ChakramEntity> extends HierarchicalModel<ChakramEntity> {
	...
	public TChakram_Model(ModelPart root) {
		chakram = root.getChild("chakram");
		grip = this.chakram.getChild("grip");
		handle = this.chakram.getChild("handle");
		spike_bottom = this.chakram.getChild("spike_bottom");
		spike_top = this.chakram.getChild("spike_top");
		spike_bottom_left = this.chakram.getChild("spike_bottom_left");
		spike_right = this.chakram.getChild("spike_right");
		spike_left = this.chakram.getChild("spike_left");
		spike_top_left = this.chakram.getChild("spike_top_left");
		spike_top_right = this.chakram.getChild("spike_top_right");
		spike_bottom_right = this.chakram.getChild("spike_bottom_right");
	}
	...
	@Override
	public void setupAnim(ChakramEntity t, float v, float v1, float v2, float v3, float v4) {
