...
public class Thrown_Chakram_Model<T extends Thrown_Chakram> extends HierarchicalModel<Thrown_Chakram> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "thrown_chakram"), "main");
