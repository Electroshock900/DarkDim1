...
public class Owl_Model<T extends Entity> extends HierarchicalModel<T> {
		...
		public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "owl"), "main");
	...
	public Owl_Model(ModelPart root) {
		...
		public static LayerDefinition createBodyLayer() {
			...
			PartDefinition tail = body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(36, 28).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(-0.5F, 3.0F, 2.5F));
