...
import net.voidless.voidless.entity.projectiles.AresArrow;
import org.joml.Matrix3f;
import org.joml.Matrix4f;

public class Ares_Arrow_Renderer<T extends AresArrow> extends EntityRenderer<T> {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/projectiles/ares_arrow.png");

    public Ares_Arrow_Renderer(EntityRendererProvider.Context manager) {
        super(manager);
    }
