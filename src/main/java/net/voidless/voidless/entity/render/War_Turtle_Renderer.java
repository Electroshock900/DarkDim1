...
import net.voidless.voidless.entity.render.layers.WarTurtleArmorLayer;
import net.voidless.voidless.entity.variants.WarTurtleVariant;
...
public class War_Turtle_Renderer extends MobRenderer<WarTurtle, War_Turtle_Model<WarTurtle>> {
        ...
        private static final Map<WarTurtleVariant, ResourceLocation> LOCATION_BY_VARIANT =
                Util.make(Maps.newEnumMap(WarTurtleVariant.class), map -> {
                    map.put(WarTurtleVariant.PLAINS,
                            ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/warturtle/warturtle.png"));
    ...
    public ResourceLocation getTextureLocation(WarTurtle cb) {
        return ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID,"textures/entity/warturtle/warturtle.png");
                //LOCATION_BY_VARIANT.get(cb.getVariant());
        //ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID,"textures/entity/custom/cactus_buddy.png");
    }
