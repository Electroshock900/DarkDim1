...
import net.voidless.voidless.entity.model.War_Turtle_Model;
...
public class WarTurtleArmorLayer extends RenderLayer<WarTurtle, War_Turtle_Model<WarTurtle>> {
    ...
    public WarTurtleArmorLayer(RenderLayerParent<WarTurtle, War_Turtle_Model<WarTurtle>> renderer, EntityModelSet models) {
        super(renderer);
        model = new War_Turtle_Model<>(models.bakeLayer(War_Turtle_Model.ARMOR_LAYER_LOCATION));
    }

    private Map<Item, ResourceLocation> ARMOR_MAP = Map.of(
            ModItems.WAR_TURTLE_ARMOR.get(), ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/warturtle/armor/iron_war_turtle_armor.png"),
            //ModItems.GOLD_WARTURTLE_ARMOR.get(), ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/warturtle/armor/gold_warturtle.png"),
            //ModItems.DIAMOND_WARTURTLE_ARMOR.get(), ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/warturtle/armor/diamond_warturtle.png"),
            ModItems.NETHERITE_WAR_TURTLE_ARMOR.get(), ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/warturtle/armor/netherite_war_turtle_armor.png")
            //ModItems.AZURITE_WARTURTLE_ARMOR.get(), ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/warturtle/armor/azurite_warturtle.png")
    );
