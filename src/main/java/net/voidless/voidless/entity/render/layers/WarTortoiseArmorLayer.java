...
public class WarTortoiseArmorLayer extends RenderLayer<WarTortoise, War_Tortoise_Model<WarTortoise>> {
    ...
    private Map<Item, ResourceLocation> ARMOR_MAP = Map.of(
            ModItems.WAR_TORTOISE_ARMOR.get(), ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/wartortoise/armor/iron_war_tortoise_armor.png")
            //ModItems.GOLD_WARTORTOISE_ARMOR.get(), ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/wartortoise/armor/gold_wartortoise.png"),
            //ModItems.DIAMOND_WARTORTOISE_ARMOR.get(), ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/wartortoise/armor/diamond_wartortoise.png"),
            //ModItems.NETHERITE_WAR_TORTOISE_ARMOR.get(), ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/wartortoise/armor/netherite_war_tortoise_armor.png")
            //ModItems.AZURITE_WARTORTOISE_ARMOR.get(), ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/wartortoise/armor/azurite_wartortoise.png")
    );
