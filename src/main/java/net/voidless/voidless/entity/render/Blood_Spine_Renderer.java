...
public class Blood_Spine_Renderer<T extends Blood_Spine> extends EntityRenderer<T> {
    public static final ResourceLocation TEXTURE = ResourceLocation.fromNamespaceAndPath(VoidlessMod.MODID, "textures/entity/projectiles/blood_spine.png");

    public Blood_Spine_Renderer(EntityRendererProvider.Context manager) {
        super(manager);
    }
